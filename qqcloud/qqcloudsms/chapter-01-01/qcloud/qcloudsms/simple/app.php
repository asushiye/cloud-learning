...
// 短信应用SDK AppID
$appid = 1400122063; // 1400开头

// 短信应用SDK AppKey
$appkey = "ed9ae16ea56f86e170ba1c71ad57a5f0";

// 需要发送短信的手机号码逗号隔开
$phoneNumbers = array("13795467304","15692198190");
$phoneNumbers1 = "13795467304";

// 短信模板ID，需要在短信应用中申请
$templateId = 173934;  // NOTE: 这里的模板ID`7839`只是一个示例，真实的模板ID需要在短信控制台中申请
...
/*try {
    ...
    $result = $ssender->send(0, "86", $phoneNumbers1,
        "【宝履科技】您的验证码是: 5678", "", "");
...
/*try {
    ...
    $result = $ssender->sendWithParam("86", $phoneNumbers1, $templateId,
